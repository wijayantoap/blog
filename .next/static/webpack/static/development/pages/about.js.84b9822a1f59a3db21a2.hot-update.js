  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(AboutPage, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_5___default.a.createElement("main", {
        ...
        __self: this
      }, "This is my first blog post"), "Okay it seems that I decided to rewrite my blog using something2 framework and i just wanna try figuring things out. anyway i might go back in using yadayada for some reason. well the progress seems a little bit off the schedule (you right i have no actual schedule to make this). welp i guess that is that"));
    }
  }]);
...
//# sourceMappingURL=about.js.84b9822a1f59a3db21a2.hot-update.js.map